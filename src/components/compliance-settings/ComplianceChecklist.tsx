    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <div className="space-y-4 my-4">
          ...
          <div className="flex items-start gap-2">
            <div className={`mt-0.5 flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center ${complianceSettings.termsOfServiceUrl ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-400'}`}>
          ...
          <div className="flex items-start gap-2">
            <div className={`mt-0.5 flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center ${complianceSettings.anonymizeExports ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-400'}`}>
